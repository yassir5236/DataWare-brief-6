    ...
    <div class="bg-gradient-to-b from-indigo-800 to-indigo-600 text-white w-64 flex-shrink-0 h-screen">
        <div class="p-4">
            ...
            <ul>
                ...
                <li class="mb-2">
                    <a href="#" onclick="loadContent('projet_owner.php')" class="flex items-center py-2 px-4 text-gray-300 hover:text-white hover:bg-indigo-700 transition duration-300 ease-in-out">
                        <svg class="w-6 h-6 mr-2" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24">
                ...
                <li class="mb-2">
                    <a href="#" onclick="loadContent('equipes_owner.php')" class="flex items-center py-2 px-4 text-gray-300 hover:text-white hover:bg-indigo-700 transition duration-300 ease-in-out">
                        <svg class="w-6 h-6 mr-2" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24">
